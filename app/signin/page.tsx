              ...
              <div className="my-4 flex items-center before:mt-0.5 before:flex-1 before:border-t before:border-neutral-300 after:mt-0.5 after:flex-1 after:border-t after:border-neutral-300 dark:before:border-neutral-500 dark:after:border-neutral-500">
                <p className="mx-4 mb-0 text-center font-semibold dark:text-neutral-200">
                  OR
                          ...
                          <button
                            className="mb-3 flex w-full items-center justify-center rounded bg-red-600 px-7 pb-2.5 pt-3 text-center text-sm font-medium uppercase leading-normal text-white shadow-red-700 transition duration-150 ease-in-out hover:bg-red-700 hover:shadow-red-600 focus:bg-red-700 focus:shadow-red-600 focus:outline-none focus:ring-0 active:bg-red-800 active:shadow-red-600 dark:shadow-black/30 dark:hover:shadow-dark-strong dark:focus:shadow-dark-strong dark:active:shadow-dark-strong"
                          ...
                          >
                            <span className="me-2 fill-white [&>svg]:h-3.5 [&>svg]:w-3.5">
                              ...
                              >
                                <path
                                  fill="#FFF"
                                  d="M256 0C114.6 0 0 114.6 0 256s114.6 256 256 256s256-114.6 256-256S397.4 0 256 0zm-6.1 416.3c-108.4 0-196.3-87.9-196.3-196.3s87.9-196.3 196.3-196.3s196.3 87.9 196.3 196.3s-87.9 196.3-196.3 196.3zm95.7-133.4l-4.2-15.6h-84.7v-63.1h47.4c-2.6 12.9-10.1 23.8-21.4 31.1v25.7h36.1l-5.9 15.6h-30.2v47.5h55.6c1.6-4.1 2.5-8.5 2.5-13C352.1 289.2 348.6 276.8 345.6 282.9z"
                                />
                              </svg>
                            </span>
